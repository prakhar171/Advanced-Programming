...
--
-- Table structure for table `foodjunc`
--

DROP TABLE IF EXISTS `foodjunc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `foodjunc` (
  `category` char(20) DEFAULT NULL,
  `fooditem` char(50) DEFAULT NULL,
  `price` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `foodjunc`
--

LOCK TABLES `foodjunc` WRITE;
/*!40000 ALTER TABLE `foodjunc` DISABLE KEYS */;
INSERT INTO `foodjunc` VALUES ('Indian','Rajma Chawal',50),('Indian','Chholey chawal',50),('Indian','Kadai Paneer',140),('Indian','Paneer Bhurgi',150),('Indian','Paneer butter masala',140),('Indian','Shahi Paneer',140),('Indian','Masala Omlet',50),('Indian','Egg Bhurji',50),('Indian','Chicken Leg Curry with Parantha',140),('Indian','Chicken Special with Parantha',140),('Chinese','Chilli chicken',180),('Chinese','Chilli Paneer',100),('Chinese','Chicken manchurian',180),('Chinese','Veg Noodles',50),('Chinese','Chicken Noodles',90),('Chinese','Chicken fried rice',90),('Chinese','Veg fried rice',50),('Kathi Roll','Veg Kathi Roll',50),('Kathi Roll','Egg Roll',60),('Kathi Roll','Paneer Kathi Roll',60),('Kathi Roll','Chicken Kathi Roll',80),('Kathi Roll','Chicken Seekh kabab Roll',80),('Kathi Roll','Chicken Salami Roll',80),('Kathi Roll','Jumbo Kathi Roll',200),('Kathi Roll','Mutton Seekh Roll',130),('kababs','Chicken Seekh kabab Punjabi Tadka',90),('kababs','Chicken Seekh kabab Nawabi',90),('kababs','Chicken Seelh kabab Lime Pudina',90),('kababs','Chicken Seekh Kabab Regular',90),('kababs','Keema Parantha',50);
/*!40000 ALTER TABLE `foodjunc` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-11-08 19:37:18
