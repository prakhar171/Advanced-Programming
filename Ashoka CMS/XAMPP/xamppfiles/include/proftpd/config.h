...
#define PR_BUILD_OPTS " '--prefix=/Applications/XAMPP/xamppfiles' '--with-modules=mod_sql:mod_sql_mysql:mod_tls' '--with-includes=/Applications/XAMPP/xamppfiles/include:/Applications/XAMPP/xamppfiles/include/ncurses' '--with-libraries=/Applications/XAMPP/xamppfiles/lib/' 'CC=gcc' 'CFLAGS=-I/Applications/XAMPP/xamppfiles/include/c-client -I/Applications/XAMPP/xamppfiles/include/libpng -I/Applications/XAMPP/xamppfiles/include/freetype2 -O3  -L/Applications/XAMPP/xamppfiles/lib -I/Applications/XAMPP/xamppfiles/include -I/Applications/XAMPP/xamppfiles/include/ncurses -arch x86_64' 'LDFLAGS=-Wl,-rpath -Wl,/Applications/XAMPP/xamppfiles/lib -L/Applications/XAMPP/xamppfiles/lib -I/Applications/XAMPP/xamppfiles/include -arch x86_64 -L/Applications/XAMPP/xamppfiles/lib -L/Applications/XAMPP/xamppfiles' 'CPPFLAGS=-I/Applications/XAMPP/xamppfiles/include/c-client -I/Applications/XAMPP/xamppfiles/include/libpng -I/Applications/XAMPP/xamppfiles/include/freetype2 -O3 -L/Applications/XAMPP/xamppfiles/lib -I/Applications/XAMPP/xamppfiles/include -I/Applications/XAMPP/xamppfiles/include/ncurses -arch x86_64'"

/* Define to be the build CFLAGS.  */
#define PR_BUILD_CFLAGS "-I/Applications/XAMPP/xamppfiles/include/c-client -I/Applications/XAMPP/xamppfiles/include/libpng -I/Applications/XAMPP/xamppfiles/include/freetype2 -O3  -L/Applications/XAMPP/xamppfiles/lib -I/Applications/XAMPP/xamppfiles/include -I/Applications/XAMPP/xamppfiles/include/ncurses -arch x86_64 -Wall"

/* Define to be the build LDLAGS.  */
#define PR_BUILD_LDFLAGS "-L$(top_srcdir)/lib -Wl,-rpath -Wl,/Applications/XAMPP/xamppfiles/lib -L/Applications/XAMPP/xamppfiles/lib -I/Applications/XAMPP/xamppfiles/include -arch x86_64 -L/Applications/XAMPP/xamppfiles/lib -L/Applications/XAMPP/xamppfiles -L/Applications/XAMPP/xamppfiles/lib/"

/* Define to be the build LIBS.  */
#define PR_BUILD_LIBS " -lssl -lcrypto -lssl -lcrypto  -lm -lmysqlclient -lz  -lpam -lsupp  -ldl"

/* Define to be the build platform. */
#define PR_PLATFORM "DARWIN10 (DARWIN10_8_0)"
...
#define HAVE_STRUCT_DIR___DD_FD 1
...
#define PR_CONFIG_DIR "/Applications/XAMPP/xamppfiles/etc"
#endif /* PR_CONFIG_DIR */

#ifndef PR_INCLUDE_DIR
#define PR_INCLUDE_DIR "/Applications/XAMPP/xamppfiles/include"
#endif /* PR_INCLUDE_DIR */

#ifndef PR_LIBEXEC_DIR
#define PR_LIBEXEC_DIR "/Applications/XAMPP/xamppfiles/libexec"
#endif /* PR_LIBEXEC_DIR */

#ifndef PR_LOCALE_DIR
#define PR_LOCALE_DIR "/Applications/XAMPP/xamppfiles/share/locale"
#endif /* PR_LOCALE_DIR */

#ifndef PR_RUN_DIR
#define PR_RUN_DIR "/Applications/XAMPP/xamppfiles/var"
#endif /* PR_RUN_DIR */

#ifndef PR_CONFIG_FILE_PATH
#define PR_CONFIG_FILE_PATH "/Applications/XAMPP/xamppfiles/etc/proftpd.conf"
#endif /* PR_CONFIG_FILE_PATH */

#ifndef PR_PID_FILE_PATH
#define PR_PID_FILE_PATH "/Applications/XAMPP/xamppfiles/var/proftpd.pid"
